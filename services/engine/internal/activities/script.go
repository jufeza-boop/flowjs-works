...
// defaultScriptTimeoutMs is the JavaScript execution timeout in milliseconds
// used when the config does not specify a "timeout_ms" field.
const defaultScriptTimeoutMs = 5_000
